  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final height = constraints.maxHeight.clamp(300.0, double.infinity);
        final glyphHeight = (height * .28).clamp(72.0, 132.0);
                        ...
                        builder: (context, finished, _) => FeedbackTap(
                          onTap: !finished || _state == _MicState.listening
                              ...
                              : () => ref
                                  ...
                                  .play('assets/audio/alif/explain_2.mp3'),
                          child: Text(
                            letter,
