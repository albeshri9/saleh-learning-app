...
def validate(root=ROOT):
    ...
    for pack in catalog['packs']:
        ...
        if stage_id:
            ...
            expected_prior = ordered[:ordered.index(pid)] if pid in ordered else []
            ...
            require([q.get('reviewLessonId') for q in questions] == expected_prior, f'{pid}: review questions do not cover previous letters')
            for q in questions:
