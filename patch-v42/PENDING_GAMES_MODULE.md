...
Current status (v42 integration, 2026-08-28): v40 was merged in v41; the user-approved R2 review package is now merged on top, preserving v41 letter fitting and existing storage. See RELEASE_V42.md for verification and known transparency limitations. The original adoption-only notes below are historical.
