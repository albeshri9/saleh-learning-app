...
void main() {
  ...
  testWidgets('early review answer cancels queued narration and startup retry',
    ...
    expect(audio.assets, ['assets/audio/taa/prior_review_2.mp3']);
    stopped.value = true;
    await audio.play('assets/audio/taa/assessment_success.mp3');
    await tester.pump(const Duration(seconds: 3));
    expect(audio.assets, [
      'assets/audio/taa/prior_review_2.mp3',
  ...
  testWidgets(
    ...
    await tester.pump();
    expect(audio.assets, [
      'assets/audio/taa/prior_review_retry.mp3',
      'assets/audio/taa/prior_review_2.mp3'
    ]);
    expect(completed, 0);
    ...
    expect(audio.assets.sublist(audio.assets.length - 2), [
      'assets/audio/taa/prior_review_retry.mp3',
      'assets/audio/taa/prior_review_3.mp3'
    ]);
