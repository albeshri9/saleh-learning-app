          ...
          child: IgnorePointer(
            child: SizedBox(
              ...
              child: FittedBox(
                ...
                child: Padding(
                  padding: const EdgeInsets.fromLTRB(6, 2, 6, 22),
                  child: SizedBox(
                      width: labelMaxLines > 1 ? 168 : null,
                      child: AppButton(
                        label: label,
                        icon: icon,
                        ...
                        textStyle: AppTypography.button.copyWith(
                            fontSize: labelMaxLines > 1 ? 16 : 18, height: 1.1),
...
class _ImmediateTap extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      FeedbackTap(immediate: true, onTap: onPressed, child: child);
}
