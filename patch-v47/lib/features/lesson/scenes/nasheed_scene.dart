              ...
              children: [
                Text(
                  ...
                  style: AppTypography.title
                      .copyWith(fontSize: compact ? 20 : 30, height: 1.2),
                ),
                if (widget.scene.data['media'] == null)
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
        builder: (context, bounds) => SizedBox(
              height: bounds.maxHeight.clamp(0, compact ? 72.0 : 100.0),
              child: Row(
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: AnimatedContainer(
                          ...
                          height:
                              bounds.maxHeight.clamp(0, compact ? 68.0 : 94.0) *
                                  heights[i] *
                                  (active && i / heights.length <= progress
                                      ? 1
                                      : .72),
