          ...
          child: Column(children: [
            if (c.maxHeight > 190)
              const Padding(
                  ...
                  child: Text('المرحلة الأولى • ١٥ مغامرة مع صالح',
                      style: TextStyle(
                          fontSize: 20,
                          color: gameInk,
...
class _GamesWorldScreenState extends ConsumerState<GamesWorldScreen> {
  ...
  Widget build(BuildContext context) {
    final phaseGames = gameCatalog
            .where((e) => e.world == widget.world && e.isFirstPhase)
            .toList(),
        availableLevels =
            (phaseGames.map((e) => e.level).toSet().toList()..sort()),
        games =
            phaseGames.where((e) => level == 0 || e.level == level).toList(),
                    ...
                    child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          SingleChildScrollView(
                              ...
                              child: Row(children: [
                                for (final n in [0, ...availableLevels])
                                  Padding(
