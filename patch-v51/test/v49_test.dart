...
void main() {
  ...
  test(
      'checkpoint has seven recognition, one drag board, seven speech and writing tasks',
      () {
    ...
    expect(writing, hasLength(14));
    expect(writing.where((task) => task['type'] == 'guided'), hasLength(7));
