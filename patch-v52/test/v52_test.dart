...
void main() {
  test('v52 uses the four approved inclusive praise phrases and audio', () {
  ...
  test('first-launch introduction is bundled and versioned once-only', () {
    expect(
        FirstLaunchNarration.preferenceKey, 'first_launch_welcome_v52_played');
    expect(FirstLaunchNarration.asset,
        'assets/audio/first_launch_welcome_v52.mp3');
