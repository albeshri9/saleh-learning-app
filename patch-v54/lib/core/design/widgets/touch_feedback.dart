...
class _FeedbackTapState extends State<FeedbackTap> {
  ...
  Future<void> _activate() async {
    ...
    _release?.cancel();
    _release = Timer(const Duration(milliseconds: 170), () {
  ...
  Widget build(BuildContext context) {
    ...
    final visual = AnimatedScale(
      // Press acknowledgement is functional feedback, so it remains active
      // even when the operating system reduces decorative motion.
      scale: _pressed ? .93 : 1,
