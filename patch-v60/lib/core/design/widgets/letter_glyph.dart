...
class LetterGlyph extends StatelessWidget {
  ...
  static LetterTraceTemplate? templateFor(String letter) => switch (letter) {
        ...
        'ثَ' || 'ث' => thaaFathaTemplate,
        'جَ' || 'ج' => jeemFathaTemplate,
        'حَ' || 'ح' => haaFathaTemplate,
        'خَ' || 'خ' => khaaFathaTemplate,
        'دَ' || 'د' => dalFathaTemplate,
        'ذَ' || 'ذ' => dhalFathaTemplate,
        'رَ' || 'ر' => raaFathaTemplate,
        'زَ' || 'ز' => zayFathaTemplate,
        'سَ' || 'س' => seenFathaTemplate,
        'شَ' || 'ش' => sheenFathaTemplate,
        'صَ' || 'ص' => saadFathaTemplate,
        'ضَ' || 'ض' => daadFathaTemplate,
        'طَ' || 'ط' => tahFathaTemplate,
        'ظَ' || 'ظ' => zahFathaTemplate,
        'عَ' || 'ع' => aynFathaTemplate,
        'غَ' || 'غ' => ghaynFathaTemplate,
        'فَ' || 'ف' => faaFathaTemplate,
        'قَ' || 'ق' => qaafFathaTemplate,
        'كَ' || 'ك' => kaafFathaTemplate,
        'لَ' || 'ل' => laamFathaTemplate,
        'مَ' || 'م' => meemFathaTemplate,
        'نَ' || 'ن' => noonFathaTemplate,
        'هَ' || 'ه' => hehFathaTemplate,
        'وَ' || 'و' => wawFathaTemplate,
        'يَ' || 'ي' => yaaFathaTemplate,
