...
class _WorldScreenState extends ConsumerState<WorldScreen> {
                      ...
                      return FadeTransition(
                          ...
                          child: SlideTransition(
                              ...
                              child: ScaleTransition(
                                  scale: Tween<double>(begin: .97, end: 1)
                                      .animate(curved),
                                  child: child)));
                    },
                    child: KeyedSubtree(
  ...
  Widget _garden(BoxConstraints size, LessonProgress? p) => Padding(
      ...
      child: LessonsCatalog(
          foundationTrack: _foundationTrack,
          onLesson: (id) => _lesson(lessonId: id)));
                    ...
                    child: FractionallySizedBox(
                      ...
                      child: _FoundationTrackCard(
                        ...
                        icon: const SizedBox.square(
                          key: ValueKey('track-icon-read-write'),
                          dimension: 48,
                          child: _FoundationTrackIcon.readWrite(),
                        ),
                  ...
                  child: Align(
                    child: FractionallySizedBox(
                      ...
                      child: _FoundationTrackCard(
                        ...
                        icon: const SizedBox.square(
                          key: ValueKey('track-icon-reading'),
                          dimension: 48,
                          child: _FoundationTrackIcon.reading(),
                        ),
                        onTap: () => _chooseFoundationTrack(
                  ...
                  child: Align(
                    child: FractionallySizedBox(
                      ...
                      child: _FoundationTrackCard(
                        ...
                        icon: const SizedBox.square(
                          key: ValueKey('track-icon-writing'),
                          dimension: 48,
                          child: _FoundationTrackIcon.writing(),
                        ),
                        onTap: () => _chooseFoundationTrack(
  ...
  Widget build(BuildContext context) => Semantics(
        ...
        child: FeedbackTap(
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            ...
            final circleSize = compact ? 70.0 : 84.0;
            return Container(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 5),
                        Icon(Icons.west_rounded, size: compact ? 15 : 18),
                      ],
                    ),
                  ),
                ],
...
class _FoundationTrackIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SizedBox.square(
        ...
        child: Center(
          child: switch (kind) {
            _TrackIconKind.reading =>
              const Icon(Icons.menu_book_rounded, size: 40),
            _TrackIconKind.writing => const Icon(Icons.draw_rounded, size: 40),
            _TrackIconKind.readWrite => const SizedBox.square(
                dimension: 46,
                child: Stack(
