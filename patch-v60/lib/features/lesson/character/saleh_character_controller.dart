...
class SalehCharacterController extends ChangeNotifier {
  ...
  /// A bounded gesture has priority, then releases back to live speech.
  void beginGesture(SalehPose pose) {
    _gesture = pose;
    notifyListeners();
  }
  ...
  void reset() {
    _gesture = null;
    _narrating = false;
    _basePose = SalehPose.idle;
    // Scene replacement occurs during build; callers render the new pose.
  }
