...
import 'mcq_scene.dart';

/// المراجعة القبلية: سؤال مسموع وخيارات حروف، دون عرض الإجابة في السؤال.
/// يبقى عرض البطاقات القديم مدعومًا للمحتوى الذي لا يحتوي أسئلة.
class ReviewScene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (scene.data['questions'] is List) {
      return McqScene(scene: scene, api: api);
    }
    final items =
