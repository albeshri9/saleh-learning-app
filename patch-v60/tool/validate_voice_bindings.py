...
IDS = ['alif','baa','taa','thaa','jeem','haa','khaa',
       ...
       'sheen','saad','daad','tah','zah','ayn','ghayn','faa',
       'qaaf','kaaf','laam','meem','noon','heh','waw','yaa']
...
PURPOSES = {
    ...
    'assets/audio/checkpoint_1/retry_only_v51.mp3': {'pronunciation', 'checkpoint', 'review', 'multipleChoice', 'assessment'},
}
REVIEW_QUESTIONS = {
